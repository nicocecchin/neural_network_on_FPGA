...
HD_PWD='D:/neural_network/neural_network.runs/output_layer_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log output_layer_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source output_layer_1.tcl
