...
HD_PWD='D:/neural_network/neural_network.runs/pixel_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pixel_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pixel_memory.tcl
