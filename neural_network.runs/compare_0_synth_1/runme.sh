...
HD_PWD='D:/neural_network/neural_network.runs/compare_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compare_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compare_0.tcl
