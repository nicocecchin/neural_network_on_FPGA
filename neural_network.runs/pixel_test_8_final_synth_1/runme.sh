...
HD_PWD='D:/neural_network/neural_network.runs/pixel_test_8_final_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pixel_test_8_final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pixel_test_8_final.tcl
