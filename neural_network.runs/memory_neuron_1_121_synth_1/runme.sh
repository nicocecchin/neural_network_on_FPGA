...
HD_PWD='D:/neural_network/neural_network.runs/memory_neuron_1_121_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_neuron_1_121.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memory_neuron_1_121.tcl
