...
#
# Script generated by Vivado on Mon Apr 14 23:04:54 +0200 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : compare_0.sh
...
#
# Usage        : compare_0.sh
#                compare_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                compare_0.sh [-reset_run]
#                compare_0.sh [-reset_log]
#                compare_0.sh [-help]
#
...
#                script (type 'compare_0.sh -help' for more information).
#
...
# script info
echo -e "compare_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./compare_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.compare_0 xil_defaultlib.glbl -o compare_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./compare_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key compare_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc compare_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./compare_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: compare_0.sh [-help]\n\
Usage: compare_0.sh [-step]\n\
Usage: compare_0.sh [-lib_map_path]\n\
Usage: compare_0.sh [-reset_run]\n\
Usage: compare_0.sh [-reset_log]\n\
Usage: compare_0.sh [-keep_index]\n\
Usage: compare_0.sh [-noclean_files]\n\n\
