...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot compare_0 xil_defaultlib.compare_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim compare_0 -key {Behavioral:sim_1:Functional:compare_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb compare_0.wdb xsim.dir libdpi.so)
