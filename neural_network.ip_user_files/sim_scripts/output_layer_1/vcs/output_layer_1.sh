...
#
# Script generated by Vivado on Sat Apr 12 19:15:20 +0200 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : output_layer_1.sh
...
#
# Usage        : output_layer_1.sh
#                output_layer_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                output_layer_1.sh [-reset_run]
#                output_layer_1.sh [-reset_log]
#                output_layer_1.sh [-help]
#
...
#                script (type 'output_layer_1.sh -help' for more information).
#
...
# script info
echo -e "output_layer_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./output_layer_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.output_layer_1 xil_defaultlib.glbl -o output_layer_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./output_layer_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key output_layer_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc output_layer_1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./output_layer_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: output_layer_1.sh [-help]\n\
Usage: output_layer_1.sh [-step]\n\
Usage: output_layer_1.sh [-lib_map_path]\n\
Usage: output_layer_1.sh [-reset_run]\n\
Usage: output_layer_1.sh [-reset_log]\n\
Usage: output_layer_1.sh [-keep_index]\n\
Usage: output_layer_1.sh [-noclean_files]\n\n\
