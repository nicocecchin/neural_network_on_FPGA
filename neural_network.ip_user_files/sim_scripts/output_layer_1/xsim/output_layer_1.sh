...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot output_layer_1 xil_defaultlib.output_layer_1 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim output_layer_1 -key {Behavioral:sim_1:Functional:output_layer_1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb output_layer_1.wdb xsim.dir libdpi.so)
