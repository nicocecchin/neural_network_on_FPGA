...
#
# Script generated by Vivado on Fri Apr 11 15:58:06 +0200 2025
...
#
# Usage        : accumulator.sh
#                accumulator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                accumulator.sh [-reset_run]
#                accumulator.sh [-reset_log]
#                accumulator.sh [-help]
#
...
#                script (type 'accumulator.sh -help' for more information).
#
...
# script info
echo -e "accumulator.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./accumulator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(ucli.key accumulator_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc accumulator_simv.daidir vcs_lib c.obj)
...
Usage: accumulator.sh [-step]\n\
Usage: accumulator.sh [-lib_map_path]\n\
Usage: accumulator.sh [-reset_run]\n\
Usage: accumulator.sh [-reset_log]\n\
Usage: accumulator.sh [-keep_index]\n\
