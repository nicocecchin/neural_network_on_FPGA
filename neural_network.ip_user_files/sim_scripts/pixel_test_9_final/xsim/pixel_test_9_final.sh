...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot pixel_test_9_final xil_defaultlib.pixel_test_9_final -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pixel_test_9_final -key {Behavioral:sim_1:Functional:pixel_test_9_final} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pixel_test_9_final.wdb xsim.dir libdpi.so)
