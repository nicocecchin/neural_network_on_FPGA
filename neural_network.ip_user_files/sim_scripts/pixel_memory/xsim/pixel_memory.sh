...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot pixel_memory xil_defaultlib.pixel_memory -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pixel_memory -key {Behavioral:sim_1:Functional:pixel_memory} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pixel_memory.wdb xsim.dir libdpi.so)
