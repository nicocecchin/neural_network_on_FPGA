...
#
# Script generated by Vivado on Tue May 06 15:41:11 +0200 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : pixel_test_5_final.sh
...
#
# Usage        : pixel_test_5_final.sh
#                pixel_test_5_final.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pixel_test_5_final.sh [-reset_run]
#                pixel_test_5_final.sh [-reset_log]
#                pixel_test_5_final.sh [-help]
#
...
#                script (type 'pixel_test_5_final.sh -help' for more information).
#
...
# script info
echo -e "pixel_test_5_final.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pixel_test_5_final.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pixel_test_5_final xil_defaultlib.glbl -o pixel_test_5_final_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pixel_test_5_final_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pixel_test_5_final_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pixel_test_5_final_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pixel_test_5_final.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pixel_test_5_final.sh [-help]\n\
Usage: pixel_test_5_final.sh [-step]\n\
Usage: pixel_test_5_final.sh [-lib_map_path]\n\
Usage: pixel_test_5_final.sh [-reset_run]\n\
Usage: pixel_test_5_final.sh [-reset_log]\n\
Usage: pixel_test_5_final.sh [-keep_index]\n\
Usage: pixel_test_5_final.sh [-noclean_files]\n\n\
